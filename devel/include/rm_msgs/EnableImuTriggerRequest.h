...
struct EnableImuTriggerRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _imu_name_type;
...
struct Printer< ::rm_msgs::EnableImuTriggerRequest_<ContainerAllocator> >
{
  ...
  {
    s << indent << "imu_name: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.imu_name);
