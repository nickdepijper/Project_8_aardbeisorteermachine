...
struct TargetDetectionArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::rm_msgs::TargetDetection_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rm_msgs::TargetDetection_<ContainerAllocator> >::other >  _detections_type;
...
struct MD5Sum< ::rm_msgs::TargetDetectionArray_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x2442aa5c7fac7ab6ULL;
  static const uint64_t static_value2 = 0x58ecefac0fe6e1aaULL;
};
