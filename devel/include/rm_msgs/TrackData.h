...
struct TrackData_
{
  ...
  _target_pos_type target_pos;
   ...
   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _target_vel_type;
...
struct MD5Sum< ::rm_msgs::TrackData_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x5958bfc9dd35e926ULL;
  static const uint64_t static_value2 = 0x778542c63b3985b6ULL;
};
...
struct Printer< ::rm_msgs::TrackData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rm_msgs::TrackData_<ContainerAllocator>& v)
  {
    ...
    s << indent << "target_vel: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.target_vel);
  }
};
