...
echo_and_run cd "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/nick/AardbeiSorteerMachine/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
