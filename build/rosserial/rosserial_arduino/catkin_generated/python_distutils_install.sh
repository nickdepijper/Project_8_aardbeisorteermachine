...
echo_and_run cd "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/nick/AardbeiSorteerMachine/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
