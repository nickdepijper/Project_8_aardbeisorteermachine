...
echo_and_run cd "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/nick/AardbeiSorteerMachine/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
