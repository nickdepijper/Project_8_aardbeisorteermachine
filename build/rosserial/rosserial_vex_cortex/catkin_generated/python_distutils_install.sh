...
echo_and_run cd "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nick/AardbeiSorteerMachine/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/nick/AardbeiSorteerMachine/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
