...
echo_and_run cd "/home/nick/Project_8_aardbeisorteermachine/src/rqt_ez_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nick/Project_8_aardbeisorteermachine/src/rqt_ez_publisher/setup.py" \
     \
    build --build-base "/home/nick/Project_8_aardbeisorteermachine/build/rqt_ez_publisher" \
    install \
    --root="${DESTDIR-/}" \
